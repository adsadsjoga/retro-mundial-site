...
export default function Navbar({ cartCount, onCartOpen, onNavigate, currentPage, onAdminClick }) {
  ...
  return (
    <nav className={`fixed top-8 left-0 right-0 z-30 transition-all duration-300 ${scrolled ? 'bg-black/95 backdrop-blur-sm border-b border-gray-800' : 'bg-transparent'}`}>
